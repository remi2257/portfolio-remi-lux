...
const professionalExperience: ProfessionalExperienceSection = {
  ...
  subSectionRecord: {
    meero: {
      ...
      points: [
        "Création du WebPlayer, un outil permettant aux concessionnaires automobiles d'intégrer leurs photos directement sur leur site web.",
        "Déploiement du package sur NPM avec différents adaptateurs (React, Vue, ...).",
        "Développement de l'application Cockpit, un outil interne basé sur Next.js permettant aux clients de gérer leurs pipelines de photos.",
      ],
    },
    souk: {
