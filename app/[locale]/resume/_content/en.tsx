...
const professionalExperience: ProfessionalExperienceSection = {
  ...
  subSectionRecord: {
    meero: {
      ...
      points: [
        "Created the WebPlayer, a tool allowing car dealers to integrate their photos directly on their website.",
        "Deployed the package on NPM with various adapters (React, Vue, ...).",
        "Developed the Cockpit application, an internal tool based on Next.js that allows clients to manage their photo pipelines.",
      ],
    },
    souk: {
