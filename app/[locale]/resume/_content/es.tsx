...
const professionalExperience: ProfessionalExperienceSection = {
  ...
  subSectionRecord: {
    meero: {
      ...
      points: [
        "Creación del WebPlayer, una herramienta que permite a los concesionarios de automóviles integrar sus fotos directamente en su sitio web.",
        "Despliegue del paquete en NPM con varios adaptadores (React, Vue, ...).",
        "Desarrollo de la aplicación Cockpit, una herramienta interna basada en Next.js que permite a los clientes gestionar sus flujos de fotos.",
      ],
    },
    souk: {
